...
const Volupcoming = () => {
  ...
  //   fetch(APIS.OrgUpcomingEvent, requestOptions)
    ...
    <View>
      {data === 'NO PAST EVENT FOUND' ? (
        ...
        <FlatList
          ...
          <TouchableOpacity onPress={() =>  navigation.navigate('VolEventDetails')}>
            <Item item={item} />
            </TouchableOpacity>}
        ...
        />
         ...
         {/* <TouchableOpacity
          ...
          <TouchableOpacity
      style={styles.floatingButton}
      onPress={() => navigation.navigate('VolEventDetails')}>
      <LinearGradient
